...
import com.nwnu.shortlink.project.dao.entity.LinkOsStatsDO;
...
public interface LinkOsStatsMapper extends BaseMapper<LinkOsStatsDO> {
     ...
     * 记录地区访问监控数据
     */
    @Insert("INSERT INTO t_link_os_stats (full_short_url, gid, date, cnt, os, creat_time, update_time, del_flag) " +
